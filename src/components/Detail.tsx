    ...
    <>
      ...
      <div className="relative w-full">
        <div
          ...
          style={{ width: "full", height: "50", backgroundColor: "#f9f1e7" }}
        >
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center">
              <h3 className="text-5xl font-semibold mb-3">{subtitle}</h3>
            ...
            <div className="flex-1 lg:pl-8">
              ...
              <div className="mt-8">
                ...
                <div className="mt-4">
                  ...
                  <div className="flex space-x-2 mt-2">
                    <button className="text-600">
                      <FaFacebook />
                    </button>
                    <button className="text-400">
                      <RxLinkedinLogo />
                    </button>
